...
'enha' => array(
	...
	'revision'     => 'Show Webradio sampling info in Playback while stop'
					...
					.'<br>Add <white>below countdown</white> = stop'
					.'<br>Add show/hide Playsource button in display setting'
					.'<br>Change <white>coverart bottom</white> to stop, <white>cover art bottom corners</white> = toggle buttons'
					.'<br>...'
