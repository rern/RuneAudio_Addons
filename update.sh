...
if ! grep -q packagestatus /srv/http/addonstitle.sh; then
	wget -qN --no-check-certificate https://github.com/rern/RuneAudio_Addons/raw/UPDATE/srv/http/addonstitle.sh
fi
